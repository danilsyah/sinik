...
<div class="row">
	<div class="col-md-12">
		<div class="card mb-4">
			<div class="card-body">
				<div class="card-title mb-3">Edit Pasien</div>
				...
				<form action="{{ route('pasiens.update', $pasien->id) }}" method="POST">
					...
					<div class="form-row">
                        <div class="form-group col-md-12 mb-3">
                            ...
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Enter nama" required value="{{ $pasien->nama }}">
                            @error('nama')
                        ...
                        <div class="form-group col-md-12 mb-3">
                            ...
                            <select name="jenkel" id="jenkel" required class="form-control form-control-rounded @error('jenkel') is-invalid @enderror">
                                <option value="{{ $pasien->jenkel }}">{{ $pasien->jenkel }}</option>
                        ...
                        <div class="form-group col-md-12 mb-3">
                            ...
                            <input type="number" name="umur" class="form-control @error('umur') is-invalid @enderror" id="umur" placeholder="Enter Umur" required value="{{ $pasien->umur }}">
                            @error('umur')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
						<div class="form-group col-md-8 mb-3">
							...
							<select name="village_id" id="village_id" required
								...
								<option value="{{ $pasien->village_id }}">{{ $pasien->village->name }}</option>
						...
						<div class="form-group col-md-8 mb-3">
                            ...
                            <input type="text" name="alamat_detail" class="form-control @error('alamat_detail') is-invalid @enderror" id="alamat_detail" placeholder="Enter alamat detail" required value="{{ $pasien->alamat_detail }}">
                            @error('alamat_detail')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
						</div>
